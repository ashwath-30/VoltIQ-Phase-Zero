  ...
  return (
    <LegalPageLayout title="Terms of Service" lastUpdated="July 11, 2026">
      <LegalSection title="1. Acceptance of terms">
        <p>
          By creating an account or using VoltIQX, you agree to these Terms of Service and our{" "}
          <a href="/privacy" className="text-primary hover:underline">
            Privacy Policy
          </a>
          . If you don't agree, please don't use VoltIQX.
        </p>
      </LegalSection>

      <LegalSection title="2. Description of the service">
        <p>
          VoltIQX is an early-stage home energy auditing platform. It analyzes utility bills you
          upload, generates forecasts and an Energy Health Score from your usage history, and provides
          an AI Assistant for questions about your account. VoltIQX is under active development —
      ...
      <LegalSection title="3. Your account">
        <p>
          ...
          least 18 years old to use VoltIQX.
        </p>
      </LegalSection>
      ...
      <LegalSection title="4. Acceptable use">
        ...
        <ul className="ml-5 list-disc space-y-1.5">
          ...
          <li>Use VoltIQX for any unlawful purpose, or to violate anyone else's rights</li>
          <li>Attempt to access another user's account or data</li>
          <li>Interfere with or disrupt VoltIQX's infrastructure, or attempt to bypass its security</li>
          <li>Use automated means to scrape or extract data from VoltIQX at scale without permission</li>
        </ul>
      </LegalSection>
      ...
      <LegalSection title="5. Your content">
        <p>
          ...
          uploading a bill, you grant VoltIQX a limited license to process it (including via AI models)
      ...
      <LegalSection title="6. Forecasts, scores, and AI-generated content are estimates">
        <p>
          This is important: VoltIQX's forecasts, Energy Health Score, peer comparisons, notifications,
          ...
          performance) may differ from what VoltIQX predicts. Confidence scores reflect how much data
      ...
      <LegalSection title="7. Pricing">
        <p>
          VoltIQX is currently free to use. If we introduce paid plans in the future, we'll provide
      ...
      <LegalSection title="8. Intellectual property">
        <p>
          VoltIQX's software, design, and branding are owned by us and protected by applicable
          intellectual property laws. These terms don't grant you any rights to VoltIQX's intellectual
      ...
      <LegalSection title="9. Disclaimers">
        <p>
          VoltIQX is provided "as is" and "as available," without warranties of any kind, express or
      ...
      <LegalSection title="10. Limitation of liability">
        <p>
          To the fullest extent permitted by law, VoltIQX and its creators are not liable for any
      ...
      <LegalSection title="11. Termination">
        <p>
          ...
          risk to VoltIQX or other users.
        </p>
      </LegalSection>

      <LegalSection title="12. Changes to these terms">
        <p>
          We may update these terms as VoltIQX evolves. We'll update the "Last updated" date above when
